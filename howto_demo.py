...
class HowToStep(BaseModel):
    ...
    description: str = Field(
        description="description of specific step to take in series of steps to solve problem / accomplish task"
    )
    url: str = Field(
...
class HowToSteps(BaseModel):
    ...
    summary: str = Field(
        description="High level summary / commentary on how to solve problem / accomplish. task"
    )
